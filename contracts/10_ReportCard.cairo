...
##### Module 10 #####
#
# This module generates artifacts that represent complex traits
# that have assessed and administered by some system.
# It predominantly is used by module 10, in which a state channel
# game could be summarised for each player. A report card is an
# attestation of the skill or behaviour of a player that they
# can own as proof of the nature of their achievements.
#
####################
