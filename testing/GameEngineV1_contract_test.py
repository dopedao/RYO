...
async def test_pseudorandom():
    ...
    # Call for sequential psuedo randomn numbers.
    (rand1, ) = await engine_contract.get_pseudorandom().invoke()
    (rand2, ) = await engine_contract.get_pseudorandom().invoke()
    (rand3, ) = await engine_contract.get_pseudorandom().invoke()
    (rand4, ) = await engine_contract.get_pseudorandom().invoke()
    (rand5, ) = await engine_contract.get_pseudorandom().invoke()
    (rand6, ) = await engine_contract.get_pseudorandom().invoke()
    (rand7, ) = await engine_contract.get_pseudorandom().invoke()

    print(rand1, rand2, rand3, rand4, rand5, rand6, rand7)
    # assert rand7==1
